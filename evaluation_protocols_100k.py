# -*- coding: utf-8 -*-
"""
Protocoles d'évaluation pour les fichiers de mots de passe générés (100k).

Exemples d'utilisation :
    python evaluation_protocols_100k.py --generated 100k_decoder2.txt --name Decoder2-100k
    python evaluation_protocols_100k.py --generated 100k_gru.txt --name GRU-100k --protocol both
"""
...
def main():
    ap = argparse.ArgumentParser(
        description="Exécuter les protocoles d'évaluation sur un fichier de mots de passe généré (100k) contre eval.txt"
    )
    ap.add_argument("--eval", default="eval.txt", help="Chemin du fichier d'évaluation/référence")
    ap.add_argument("--generated", default="100k_decoder2.txt", help="Chemin du fichier de mots de passe générés")
    ap.add_argument("--name", default="Decoder2-100k", help="Étiquette affichée dans les rapports")
    ap.add_argument(
        "--protocol",
